...
import BrianOtieno from '../assets/BrianOtieno.jpg';
import GraceWanjiku from '../assets/GraceWanjiku.jpg';
import Sarah$DavidMutiso from '../assets/Sarah&DavidMutiso.jpg';
import KCIC from '../assets/KCIC.jpg';
import naivas from '../assets/naivas.jpg';
import TwigaFoods from '../assets/TwigaFoods.jpg';
import JavaHouse from '../assets/JavaHouse.jpg';
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="h-56 overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Brian Otieno</h3>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              <div className="h-56 overflow-hidden">
                <img 
                  src={Sarah$DavidMutiso} 
                  alt="Farmer Sarah & David Mutiso" 
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = '/placeholder-farmer.jpg';
                  }}
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Sarah & David Mutiso</h3>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/2">
              ...
              <div className="mt-8 flex space-x-4">
                ...
                <a href="https://twitter.com/savannatek" className="text-green-600 hover:text-green-700">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </a>
                <a href="https://instagram.com/savanna.tek" className="text-green-600 hover:text-green-700">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
