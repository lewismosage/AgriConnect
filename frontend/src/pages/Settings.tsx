...
const farmAboutSchema = z.object({
  ...
  sustainability: z
    .string()
    .min(20, "Sustainability practices must be at least 20 characters"),
});
...
const Settings: React.FC = () => {
  ...
  const {
    register: registerFarmAbout,
    handleSubmit: handleFarmAboutSubmit,
    formState: { errors: farmAboutErrors },
  } = useForm({
  ...
  const onSubmitFarmDetails = async (data: any) => {
    try {
      if (farmImage) {
        ...
        formData.append("farm_name", data.name);
        formData.append("location", data.location);
        formData.append("specialty", data.specialty);
        formData.append("description", data.description);
        formData.append("farm_image", farmImage);
      ...
      setModalMessage("Failed to update farm details. Please try again.");
      setIsModalOpen(true);
    }
  };
  ...
  const onSubmitFarmAbout = async (data: any) => {
    try {
      ...
      setModalMessage("Failed to update farm information. Please try again.");
      setIsModalOpen(true);
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex mb-8 border-b">
          {[
            ...
            },
            {
              id: "account",
              label: "Account",
              icon: <Mail className="mr-2 w-5 h-5" />,
            },
            {
              id: "security",
              label: "Security",
        ...
        {activeSection === "profile" && (
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <form
              onSubmit={handleFarmDetailsSubmit(onSubmitFarmDetails)}
              className="space-y-6"
            >
              {/* Farm Image Upload */}
              <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  {farmDetailsErrors.name && (
                    <p className="mt-1 text-sm text-red-600">
                      {farmDetailsErrors.name.message}
                    </p>
                  )}
                </div>
                <div>
                  ...
                  {farmDetailsErrors.location && (
                    <p className="mt-1 text-sm text-red-600">
                      {farmDetailsErrors.location.message}
                    </p>
                  )}
                </div>
                <div>
                  ...
                  {farmDetailsErrors.specialty && (
                    <p className="mt-1 text-sm text-red-600">
                      {farmDetailsErrors.specialty.message}
                    </p>
                  )}
                </div>
                <div className="md:col-span-2">
                  ...
                  {farmDetailsErrors.description && (
                    <p className="mt-1 text-sm text-red-600">
                      {farmDetailsErrors.description.message}
                    </p>
                  )}
                </div>
              </div>
        ...
        {activeSection === "account" && (
          <div className="bg-white rounded-lg shadow-md p-6 space-y-8">
            ...
            <div className="border-t pt-6">
              ...
              <form
                onSubmit={handleFarmAboutSubmit(onSubmitFarmAbout)}
                className="space-y-6"
              >
                <div>
                  <label
                ...
                <div>
                  ...
                  {farmAboutErrors.sustainability && (
                    <p className="mt-1 text-sm text-red-600">
                      {farmAboutErrors.sustainability.message}
                    </p>
                  )}
                </div>
