...
const FarmRegistration = () => {
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
        <div
          className={`flex items-center ${
            step > 1 ? "text-emerald-600" : "text-gray-600"
          }`}
        >
          <div
        ...
        <ChevronsRight
          className={`h-4 w-4 ${
            step > 1 ? "text-emerald-600" : "text-gray-300"
          } hidden sm:block`}
        />
        <div
          className={`flex items-center ${
            step > 2 ? "text-emerald-600" : "text-gray-600"
          }`}
        >
          <div
            className={`rounded-full p-2 ${
        ...
        <ChevronsRight
          className={`h-4 w-4 ${
            step > 2 ? "text-emerald-600" : "text-gray-300"
          } hidden sm:block`}
        />
        <div
          className={`flex items-center ${
            step > 3 ? "text-emerald-600" : "text-gray-600"
          }`}
        >
          <div
            className={`rounded-full p-2 ${
  ...
  const renderFarmDetailsForm = () => (
    <form
      onSubmit={handleSubmitFarm(onSubmitFarmDetails)}
      className="space-y-6"
    >
      <div>
        <label
  ...
  const renderFarmerDetailsForm = () => (
    <form
      onSubmit={handleSubmitFarmer(onSubmitFarmerDetails)}
      className="space-y-6"
    >
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
          ...
          {farmerErrors.firstName && (
            <p className="mt-1 text-sm text-red-600">
              {farmerErrors.firstName.message}
            </p>
          )}
        </div>
      ...
      <div>
        ...
        {farmerErrors.confirmPassword && (
          <p className="mt-1 text-sm text-red-600">
            {farmerErrors.confirmPassword.message}
          </p>
        )}
      </div>
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500">
                Start with a free trial to explore AgriConnect.
              </p>
            </div>
            {selectedPlan === "free" && (
      ...
      {watchPayment("paymentMethod") === "mpesa" && (
        <div>
          ...
          {paymentErrors.mpesaNumber && (
            <p className="mt-1 text-sm text-red-600">
              {paymentErrors.mpesaNumber.message}
            </p>
          )}
          <div>
        ...
        <>
          <div>
            ...
            {paymentErrors.bankDetails?.cardNumber && (
              <p className="mt-1 text-sm text-red-600">
                {paymentErrors.bankDetails.cardNumber.message}
              </p>
            )}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {paymentErrors.bankDetails?.expiryDate && (
                <p className="mt-1 text-sm text-red-600">
                  {paymentErrors.bankDetails.expiryDate.message}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {paymentErrors.bankDetails?.cvv && (
                <p className="mt-1 text-sm text-red-600">
                  {paymentErrors.bankDetails.cvv.message}
                </p>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            {paymentErrors.bankDetails?.name && (
              <p className="mt-1 text-sm text-red-600">
                {paymentErrors.bankDetails.name.message}
              </p>
            )}
          </div>
        </>
